...
// broker (leader) is the sole writer; any tokenmonitor-mcp process reads the file
// for the tokenmonitor_device_logs MCP tool. Writes flock a sibling .lock
// and rewrite-then-rename so a reader sees a whole file.
//
// Wire-compatible with tokenmonitor-mcp/internal/devlog (Go) and ../py devlog.
