...
//
// The broker (whichever tokenmonitor-mcp process won leadership and serves the
// HTTP port) is the sole writer; every tokenmonitor-mcp process — leader or
// follower — reads the file directly for the tokenmonitor_device_logs
...
const (
	...
	// the tokenmonitor_device_logs tool's `limit`.
	MaxLines = 2000
