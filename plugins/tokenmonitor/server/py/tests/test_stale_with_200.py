...
snapshot, the broker answers 200 + the cached body + an X-Tmon-Stale-Reason
...
from tmon_mcp import spend, usage
...
# ---------------------------------------------------------------------------
# Broker _stale_response: 200 + body + X-Tmon-Stale-Reason
# ---------------------------------------------------------------------------
...
def test_stale_response_sets_header_and_200():
    ...
    assert resp.headers["X-Tmon-Stale-Reason"] == "upstream 500"
