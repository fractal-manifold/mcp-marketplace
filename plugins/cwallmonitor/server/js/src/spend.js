...
// Wire-compatible with cwm-mcp Go internal/spend and cwm-mcp-py
// cwm_mcp.spend. See compat/SPEND_WIRE.md for the JSON shape and the
...
const MAX_MODELS = 8; // mirrors CWM_SPEND_MAX_MODELS
